                ...
                <div class="col-lg-12 pb-5">
                    ...
                    <div class="d-flex mb-3">
                        <p class="text-dark font-weight-medium mb-0 mr-3">Sizes:</p>
                            @foreach ($productDetail->details as $size )
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id={{ $size->size }} name="size" value="{{ $size->size }}">
                                    <label class="custom-control-label" for={{ $size->size }}>Size: {{ $size->size }} <br/> Số lượng: {{ $size->quantity }}</label>
                                </div>
                            @endforeach
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="text" class="form-control bg-secondary text-center" min="1" value="1" name="quantity">
                            <div class="input-group-btn">
