      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="{{ route('dashboard') }}">@yield('home', 'Dashboard')</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">@yield('namePage', 'Dashboard')</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">@yield('namePage', 'Dashboard')</h6>
        </nav>
            ...
            <li class="nav-item d-flex align-items-center">
              ...
              @if (Auth::check())
                                    ...
                                    <div class="" aria-labelledby="navbarDropdown" style="display: flex;justify-content: center;align-items: center;">
                                        ...
                                        <form id="logout-form" action="{{ route('admin.handleLogout') }}" method="POST" class="d-none">
                                            @csrf
                                        </form>
                                    </div>
