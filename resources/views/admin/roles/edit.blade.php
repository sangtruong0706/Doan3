    ...
    <div>
        <form action="{{ route('roles.update', $role->id) }}" method="POST">
            ...
            <div class="input-group input-group-static mb-4">
                ...
                <input type="text" class="form-control" name="display_name" value="{{ old('display_name') ?? $role->display_name}}">
                @error('display_name')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            <div class="input-group input-group-static mb-4">
                ...
                <select class="form-control" id="exampleFormControlSelect1" name="group" value="{{ $role->group }}">
